...
(function() {
    ...
    var _Game_MaptileWidth = Game_Map.prototype.tileWidth;
    var _Game_MaptileHeight = Game_Map.prototype.tileHeight;
    ...
    Game_Map.prototype.oldTileWidth = function() {
        return _Game_MaptileWidth.call(this);
    };

    Game_Map.prototype.oldTileHeight = function() {
        return _Game_MaptileHeight.call(this);
    };
    ...
    Tilemap.prototype._createLayers = function() {
        var margin = this._margin,
            ...
            tileCols = Math.ceil(this._width / this.tileWidth) + 1,
            tileRows = Math.ceil(this._height / this.tileHeight) + 1,
            layerWidth = tileCols * this.tileWidth,
            layerHeight = tileRows * this.tileHeight,
            i;
